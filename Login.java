...
public class Login
{
   ...
   //constructor
    ...
    public Menu(String name, String comment, String friend) {
       ...
       userNamelbl.setBounds(10, 50, 150, 20);
       user_name.setBounds(50, 50, 150, 20);
       user_status_lbl.setBounds(10, 80, 350, 15);
       user_state.setBounds(120, 80, 350, 15);
       ...
       menu_p.add(userNamelbl);
       menu_p.add(user_name);
       menu_p.add(user_status_lbl);
                     ...
                     else if(line.contains("Entrance")) //채팅요청을 승락해서 입장하는 경우
                     {
                        ...
                        if(hostreal.equalsIgnoreCase(host)) //해당 host인 채팅방인지 검사
                        {
                           ...
                           if(line.contains("Exit")) {
                                  user_model.removeElement(etra[1].split(" ")[0]); //나갈 경우 제거
                               }
