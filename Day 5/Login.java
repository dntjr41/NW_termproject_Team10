   ...
   public String encryptSHA256(String str) {
    ...
    public class Chatting_Room {
          ...
          public Chatting_Room(String Room_name) {
            ...
            sendTF.addActionListener(new ActionListener() {
              public void actionPerformed(ActionEvent e) {
                 out.println("chatting TEXT" + sendTF.getText());
                 sendTF.setText("");
              }
            });
    ...
    public class Menu {
       ...
       public Menu(String name, String comment, String friend) {
        ...
        JLabel t1hlbl2 = new JLabel("여기 온도쓸거야");
        
        JLabel rehlbl = new JLabel("습도");
        JLabel rehlbl2 = new JLabel("여기 습도");
              ...
              try {
                 Socket socket = new Socket(serverAddress, portnum); //입력받은 ip주소와 portnumber로 소켓 생성.
                  ...
                  while(true)
                  {
                     ...
                     else if(line.contains("chatting TEXT"))
                     {
               	  ...
               	  else if(line.contains("Request"))
               	  {
               		  ...
               		  if(temp[1].equalsIgnoreCase(curid)==true)
               		  {
               			JOptionPane.showConfirmDialog(null, 
 									"으로부터 요청이 왔습니다", "confirm", 
